...
*/
   public static void main(String args[]){
     ...
     double  a  = Double.parseDouble( JOptionPane.showInputDialog("inscira uma numero"));
     double  b  = Double.parseDouble( JOptionPane.showInputDialog("inscira uma numero"));
     double  c  = Double.parseDouble( JOptionPane.showInputDialog("inscira uma numero"));
