...
public class Agencia {
    ...
    public void setNumero(int numero) {
        ...
        if (testeNumero.length() > 4) {
            JOptionPane.showMessageDialog(null, "Número da agência inválido! É permitido apenas 4 números.");
            System.exit(0);
        } else if (numero < 0) {
            JOptionPane.showMessageDialog(null, "Número da agência inválido! Apenas números positivos são permitidos.");
            System.exit(0);
        }
        this.numero = numero;
