...
public class ContaCorrente {
    ...
    public void setNumero(int numero) {
        ...
        if (testeNumero.length() > 4) {
            JOptionPane.showMessageDialog(null, "Número inválido! É permitido apenas 4 números.");
            System.exit(0);
        } else if (numero < 0) {
            JOptionPane.showMessageDialog(null, "Número inválido! Apenas números positivos são permitidos.");
            System.exit(0);
        }
        this.numero = numero;
